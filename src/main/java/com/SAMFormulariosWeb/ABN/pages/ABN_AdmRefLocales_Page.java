...
public class ABN_AdmRefLocales_Page extends BasePage {
	...
	// Constructor
	public ABN_AdmRefLocales_Page(WebDriver driver) {
		super(driver);
	}

	@Step("Abrir formulario Administracion Referencias Locales. Url {0}")
	public ABN_AdmRefLocales_Page irFormulario(String url) {
		driver.get(url);
		Utilidades.waitInMs(1000);
		return new ABN_AdmRefLocales_Page(driver);
	}

	@Step("Agregar referencia con los datos de dominio {0}, rango {1}, descripción {2}, valor {3}")
	public boolean agregarReferencia(String dominio, String rango, String descripcion, String valor, String nombreTest)
			throws IOException {
	...
	@Step("Consultar referencia inactivo con el dominio {0}")
	public String consultarRefInactivo(String dominio, String nombreTest) throws IOException {
