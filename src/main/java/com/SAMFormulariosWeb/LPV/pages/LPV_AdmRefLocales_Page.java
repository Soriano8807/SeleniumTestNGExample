...
public class LPV_AdmRefLocales_Page extends BasePage {
	...
	// Constructor
	public LPV_AdmRefLocales_Page(WebDriver driver) {
		super(driver);
	}

	@Step("Abrir formulario Administracion Referencias Locales. Url {0}")
	public LPV_AdmRefLocales_Page irFormulario(String url) {
		driver.get(url);
		Utilidades.waitInMs(1000);
		return new LPV_AdmRefLocales_Page(driver);
	}
	...
	public boolean validarCamposObligatorios(String dominio, String nombreTest) throws IOException {
