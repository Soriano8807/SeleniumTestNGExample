...
public class ALR_AdmRefLocales_Page extends BasePage {
	...
	By txtValor2 = By.id("pt1:valorReferencia2::content");
	By txtValor3 = By.id("pt1:valorReferencia3::content");
	...
	// Constructor
	public ALR_AdmRefLocales_Page(WebDriver driver) {
		super(driver);
	}

	@Step("Abrir formulario Administracion Referencias Locales. Url {0}")
	public ALR_AdmRefLocales_Page irFormulario(String url) {
		driver.get(url);
		Utilidades.waitInMs(1000);
		return new ALR_AdmRefLocales_Page(driver);
	}

	@Step("Agregar referencia con los datos de dominio {0}, rango {1}, descripción {2}, valor {3}, valor2 {4}, valor3 {5}")
	public boolean agregarReferencia(String dominio, String rango, String descripcion, String valor, String valor2, String valor3, String nombreTest) throws IOException {
		...
		writeText(txtValor2, valor2);
		writeText(txtValor3, valor3);
	...
	public String consultarReferenciaPorParametro(String parametro,	String valorParametro, String nombreTest) throws IOException {
		...
		case "valor":
			...
			break;
		case "valor2":
			writeText(txtValor2, valorParametro);
			click(btnAceptar);
			break;
		case "valor3":
			writeText(txtValor3, valorParametro);
			click(btnAceptar);
			break;
		}
		Utilidades.waitInMs(1000);
	...
	public boolean modificarReferencia(String dominio, String descripcion, String valor, String valor2, String valor3, String nombreTest) throws IOException {
