...
public class EXA_AdmRefLocales_Page extends BasePage {
	...
	//Constructor
	public EXA_AdmRefLocales_Page(WebDriver driver) {
		super(driver);
	}
	
	@Step("Abrir formulario Administracion Referencias Locales. Url {0}")
    public EXA_AdmRefLocales_Page irFormulario(String url)  {
        driver.get(url);
        Utilidades.waitInMs(1000);
        return new EXA_AdmRefLocales_Page(driver);
    }
